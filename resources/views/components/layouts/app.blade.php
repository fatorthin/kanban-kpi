            ...
            <nav class="sidebar-nav" @click="if (window.innerWidth <= 768) mobileNavOpen = false">
                ...
                <a href="{{ route('load-monitoring') }}" wire:navigate class="nav-link {{ request()->routeIs('load-monitoring') ? 'active' : '' }}">
                    <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 13.5l3 3 3-3" />
                ...
                @if (auth()->user()->isDirector())
                    ...
                    <a href="{{ route('grade-multipliers') }}" wire:navigate class="nav-link {{ request()->routeIs('grade-multipliers') ? 'active' : '' }}">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:20px;height:20px;">
                    ...
                    <a href="{{ route('kpi-weights') }}" wire:navigate class="nav-link {{ request()->routeIs('kpi-weights') ? 'active' : '' }}">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <a href="{{ route('settings.whatsapp') }}" wire:navigate class="nav-link {{ request()->routeIs('settings.whatsapp') ? 'active' : '' }}">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a.75.75 0 0 1-.816-.916 5.974 5.974 0 0 1 1.408-2.614A8.04 8.04 0 0 1 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z" />
                        </svg>
                        WhatsApp Gateway
                    </a>
