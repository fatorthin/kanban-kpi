...
<div class="app-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('recurring-tasks') }}" wire:navigate
               class="nav-link {{ request()->routeIs('recurring-tasks') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('task-library') }}" wire:navigate
               class="nav-link {{ request()->routeIs('task-library') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('kpi-reports') }}" wire:navigate
               class="nav-link {{ request()->routeIs('kpi-reports') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <div class="main-content">
        <header class="topbar">
            ...
            <div style="display:flex;align-items:center;gap:16px;">
                <div style="font-size:13px;color:var(--color-neutral);">
