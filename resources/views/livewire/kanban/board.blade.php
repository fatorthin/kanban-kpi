<div wire:poll.5s.visible>
    ...
    <div style="display:flex;gap:10px;margin-bottom:20px;flex-wrap:wrap;">
        <input type="text" class="form-input" style="width:min(320px, 100%);" wire:model.live.debounce.300ms="filterSearch" placeholder="Search task, client, or PIC...">
        @if ($filterSearch !== '')
            <button type="button" class="btn btn-ghost btn-md" wire:click="$set('filterSearch', '')">
                Reset Search
            </button>
        @endif
